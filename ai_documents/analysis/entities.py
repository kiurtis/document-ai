...
class ArvalClassicDocumentAnalyzer:
    ...
    def get_or_create_blocks(self):
        ...
        logger.info(f'Blocks 2 and 4 :{blocks}')
    ...
    def plot_blocks(self):
        for image_path in [self.file_path_block2, self.file_path_block4]:
    ...
    def analyze_block2_text_and_signature_and_stamp(self, block2_text_image_path, verbose=False, plot_boxes=False):
        ...
        #self.analyze_block2_signature_and_stamp(block2_text_image_path)


    def analyze_block4_text_and_signature_and_stamp(self ,block4_text_image_path,verbose=False ,plot_boxes=False):
        ...
        #self.analyze_block4_signature_and_stamp(block4_text_image_path)
...
class ArvalClassicGPTDocumentAnalyzer(ArvalClassicDocumentAnalyzer):
    ...
    def analyze_block4_text_and_signature_and_stamp(self, block4_text_image_path, verbose=False, plot_boxes=False):
        ...
        payload = build_block4_checking_payload_and_signature_stamp(image_path=block4_text_image_path)
