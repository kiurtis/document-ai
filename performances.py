...
def load_ground_truth_data(status):
    ...
    ground_truth_path = f'data/performances_data/{status}/{status}_ground_truth.csv'  # Replace with your actual path
...
if __name__ == '__main__':
    ...
    if RUN_ANALYSIS:
        ...
        files_to_exclude = ['EM-272-VS_Document_p1.jpeg', # Thumb disturbance
                            'EZ-912-QS_PV_de_reprise_p2.jpeg',# content_policy_violation
                            "FA-256-WW_PV_de_Restitution_p1.jpeg", # content_policy_violation
    ...
    if RUN_METRICS_COMPUTATION:
        ...
        summary_df.to_csv(f'results/error_analysis_{dt}/summary.csv', index=False)